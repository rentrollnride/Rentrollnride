  ...
  return (
    <PublicLayout>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16 sm:py-24 space-y-8 leading-relaxed">
        ...
        <section><h2 className="text-xl font-bold uppercase mb-3">Website data</h2><p>This website allows customers to submit reservations and electronically sign rental agreements. It does not collect payment-card or driver-license data online. For signed agreements, we may retain the renter name, agreement text and version, signature timestamp, IP address, browser information, and a record hash to document the electronic transaction. Hosting and security providers may also process basic request logs.</p></section>
      </article>
    </PublicLayout>
  )
}
